    ...
    <div class="signup-form">
      <form @submit.prevent="onSubmit">
        <div class="input" :class="{invalid: $v.email.$error}">
          ...
          <!-- Binding vuelidate to input -->
          <!-- $touch is a method which is added by vuelidate -->
          <!-- From now input will be tested against validations we specified in email -->
          <input type="email" id="email" v-model="email" @blur="$v.email.$touch()" />
          <p v-if="$v.email.$error">Plese provide a valid email</p>
        </div>
        ...
        <div class="hobbies">
          ...
          <div class="hobby-list">
            ...
            <p v-if="!$v.hobbyInputs.required">Please add hobies</p>
          </div>
        </div>
...
// Like global but configured by us
// import axios from "../../axios-auth";
// Vuelidate comes with some ready-made validators which we are importing
import {
  required,
  email,
  numeric,
...
export default {
  ...
  // Using Vuelidate
  validations: {
    // Validates email data prop (Thus validators and props they validate must be of the same name)
    email: {
      required,
      email,
      unique: value => {
