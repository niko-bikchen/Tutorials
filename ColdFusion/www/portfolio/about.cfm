<cfscript>
	personalInfo = {name='Nick', dob='19.12.1999', address='12 MyAddress', phonenumber='123321123', email='my.mail@mail.com', website='http://mywebsite.com', skype='my_skype'};
</cfscript>
					...
					<div id="about">
						...
						<div class="clr">
							...
							<div class="right">
								<h2>Personal Info</h2>
								<cfoutput>
									<div class="clr"><div class="input-box">Name </div><span><cfoutput>#personalInfo.name#</cfoutput></span> </div>
									<div class="clr"><div class="input-box">Date of birth </div><span><cfoutput>#personalInfo.dob#</cfoutput></span></div>
									<div class="clr"><div class="input-box">Address</div><span><cfoutput>#personalInfo.address#</cfoutput></span></div>
									<div class="clr"><div class="input-box">Phone</div> <span><cfoutput>#personalInfo.phonenumber#</cfoutput></span>  </div>
									<div class="clr"><div class="input-box">E-mail</div><span><a href="##"><cfoutput>#personalInfo.email#</cfoutput></a></span>  </div>
									<div class="clr"><div class="input-box">Website </div> <span><a href="##"><cfoutput>#personalInfo.website#</cfoutput></a></span> </div> 
									<div class="clr"><div class="box1">Skype </div> <span><a href="##"><cfoutput>#personalInfo.skype#</cfoutput></a></span> </div> 
								</cfoutput>
							</div>
						</div>
						<div class="clr"></div>
